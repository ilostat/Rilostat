---
title: "Accessing ILOSTAT Data with Rilostat"
subtitle: "Bulk download in ILOSTAT:"
author: "ILO Department of Statistics"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Accessing ILOSTAT Data with Rilostat}
...
More advanced users can take advantage of ILOSTAT's well-structured [bulk download facility](https://ilostat.ilo.org/data/bulk/).
...
#### Main features of the ilostat R package
  ...
  - Provides access to all annual, quarterly, and monthly data available via the ILOSTAT [bulk download facility](https://ilostat.ilo.org/data/bulk/)
...
The developer of this package drew extensive inspiration from the [eurostat R package](https://CRAN.R-project.org/package=eurostat) and its related documentation:
  ...
  - [Retrieval and Analysis of Eurostat Open Data with the eurostat Package](https://journal.r-project.org/articles/RJ-2017-019/RJ-2017-019.pdf) - [Leo Lahti](https://github.com/antagomir), [Przemyslaw Biecek](https://github.com/pbiecek), [Markus Kainu](https://github.com/muuankarski) and [Janne Huovari](https://github.com/jhuovari). R Journal 9(1), 385-392, 2017.
...
tutorials, demos and apps. Please visit the [Rilostat package website](https://ilostat.github.io/Rilostat/).
...
```{r, echo =FALSE, eval=TRUE}
# options(ilostat_cache_dir = 'C:/temp')
dat <- get_ilostat(id = 'UNE_DEAP_SEX_AGE_RT_A', filters = list(ref_area = c('BRA', 'ZAF'), 
													sex = 'F', 
													classif1 = '_YGE15'), 
													quiet = TRUE)
```
...
![Employment by economic class, sex and age, South Africa, 2019](./g1_eco.png)
